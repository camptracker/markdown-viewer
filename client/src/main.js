  ...
  if (currentUser?.isAuthenticated) {
    ...
    authArea.innerHTML = `
      <div class="user-menu">
        ...
        <span class="user-name">${escapeHtmlEarly(name)}</span>
    ...
    authArea.querySelector('#loginBtn').addEventListener('click', showLoginModal);
  }
}
...
function showLoginModal() {
  ...
  overlay.innerHTML = `
    <div class="confirm-modal">
      ...
      <p class="confirm-message" style="margin-bottom:16px;">Your documents will be linked to your account.</p>
      <div style="display:flex;flex-direction:column;gap:10px;">
        <a href="/api/auth/github?visitor_id=${encodeURIComponent(visitorId)}" class="btn btn-primary" style="display:flex;align-items:center;justify-content:center;gap:8px;text-decoration:none;padding:10px 16px;">
        ...
        <a href="/api/auth/google?visitor_id=${encodeURIComponent(visitorId)}" class="btn btn-secondary" style="display:flex;align-items:center;justify-content:center;gap:8px;text-decoration:none;padding:10px 16px;">
